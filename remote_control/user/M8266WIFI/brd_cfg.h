...
#elif defined(MCU_IS_STM32F7XX)  // STM's STM32F7XX, using *GPIOB2* as nRESET  // avoid to use PE3, boards like Aplolo have conflict in output high simutenous to nearby PIO e.g. PE3&PE4
...
#define  M8266WIFI_nRESET_GPIO											GPIOC
#define  M8266WIFI_nRESET_PIN												GPIO_PIN_3
#elif defined(MCU_IS_STM32L4XX)  // STM's STM32L4XX, using *GPIOC3* as nRESET // avoid to use PE3, boards like Aplolo have conflict in output high simutenous to nearby PIO e.g. PE3&PE4
#define  M8266WIFI_nRESET_GPIO_RCC_CLOCK_EN				  __HAL_RCC_GPIOC_CLK_ENABLE()
#define  M8266WIFI_nRESET_GPIO											GPIOC
#define  M8266WIFI_nRESET_PIN												GPIO_PIN_3
...
#elif defined(MCU_IS_STM32F7XX)  // STM's STM32F7XX, using *GPIOE4* as nCS  // avoid to use PE3, boards like Aplolo have conflict in output high simutenous to nearby PIO e.g. PE3&PE4
...
#define  M8266WIFI_SPI_nCS_GPIO											GPIOC
#define  M8266WIFI_SPI_nCS_PIN											GPIO_PIN_2 
#elif defined(MCU_IS_STM32H7XX)  // STM's STM32H7XX, using *GPIOE4* as nCS  // avoid to use PE3, boards like Aplolo have conflict in output high simutenous to nearby PIO e.g. PE3&PE4
#define  M8266WIFI_SPI_nCS_GPIO_RCC_CLOCK_EN				__HAL_RCC_GPIOE_CLK_ENABLE()
#define  M8266WIFI_SPI_nCS_GPIO											GPIOE
#define  M8266WIFI_SPI_nCS_PIN											GPIO_PIN_4 
...
#define  M8266WIFI_SPI_INTERFACE_NO							3   // STM32: 1~. for STM32F4xx, try to use SPI1 other than SPI2 and SPI3, since according to datasheet, SPI1 has a better performance than SPI2 and SPI3
																										// NXP:   0~ 
...
#define GPIO_OUTPUT_HIGH(gpio,pin)	(gpio)->BSRR=pin
#define GPIO_OUTPUT_LOW(gpio,pin)		(gpio)->BSRR=pin << 16
